...
// ProgrammaticCredential The Programmatic Credential object describes service-specific credentials used
...
type ProgrammaticCredential struct {
	...
	// credential lifecycle management. The timestamp should reflect the most
	...
	// The type or category of programmatic credential, normalized to the caption
	// of the type_id value. In the case of 'Other', it is defined by the event
	// source. Examples include 'API Key', 'Service Account Key', 'Access Token',
	// 'Client Certificate', 'OAuth Token', 'Personal Access Token', etc.
	Type string `json:"type,omitempty"`

	// The unique identifier of the programmatic credential. This could be an API
	// key ID, service account key ID, access token identifier, certificate serial
	// number, or other unique identifier that distinguishes this credential from
	// others. Examples: AWS Access Key ID, GCP Service Account Key ID, Azure
