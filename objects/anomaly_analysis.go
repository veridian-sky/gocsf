...
// AnomalyAnalysis Describes the analysis of activity patterns and anomalies of target entities to
...
type AnomalyAnalysis struct {
	// The analysis targets define the scope of monitored activities, specifying
	// what entities, systems or processes are analyzed for activity patterns.
	AnalysisTargets []*AnalysisTarget `json:"analysis_targets,omitempty"`
	...
	// reference points for anomaly detection. This includes typical user
	// interaction patterns like common user-agents, expected API access
	// frequencies and patterns, standard resource utilization levels, and regular
	// traffic flows. These baselines help establish what constitutes 'normal'
