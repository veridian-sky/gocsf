...
type TunnelActivity struct {
	...
	// The event class name, as defined by class_uid value: Tunnel Activity.
	...
	// Traffic refers to the amount of data moving across the tunnel at a given
	// point of time. Ex: bytes_in and bytes_out.
	Traffic *objects.NetworkTraffic `json:"traffic,omitempty"`

	// The information about the virtual tunnel interface, e.g. utun0. This is
	// usually associated with the private (rfc-1918) ip of the tunnel.
