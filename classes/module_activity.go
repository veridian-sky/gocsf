...
// ModuleActivity Module Activity events report when a process loads or unloads the module.
type ModuleActivity struct {
	...
	// The event class name, as defined by class_uid value: Module Activity.
