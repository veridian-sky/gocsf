...
// ApplicationError Application Error events describe issues with an applications. The error message
// should be put in the event's message attribute. The metadata.product attribute
// can be used to capture the originating application information. The host profile
// can used to include the generating device information. This class is helpful for
// applications that generate or handle OCSF events and can also be used for errors
// in upstream products and services.
type ApplicationError struct {
	...
	// The event category name, as defined by category_uid value: Application
	// Activity.
	...
	// The event class name, as defined by class_uid value: Application Error.
