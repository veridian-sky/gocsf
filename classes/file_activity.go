...
// FileActivity File System Activity events report when a process performs an action on a file
// or folder.
type FileActivity struct {
	...
	// applicable. </p>For example: attachment.doc, attachment.zip/bad.doc, or
	// part.mime/part.cab/part.uue/part.doc.
