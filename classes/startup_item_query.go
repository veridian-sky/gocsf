...
// StartupItemQuery Startup Item Query events report information about discovered items, e.g.,
...
type StartupItemQuery struct {
	...
	// The event class name, as defined by class_uid value: Startup Item Query.
