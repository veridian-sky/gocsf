...
// WinRegistryValueActivity Registry Value Activity events reports when a process performs an action on a
...
type WinRegistryValueActivity struct {
	...
	// The event class name, as defined by class_uid value: Registry Value
	// Activity.
	...
	PrevRegValue *objects.WinRegValue `json:"prev_reg_value,omitempty"`
