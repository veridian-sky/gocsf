...
// resource to assess permissions, access patterns, and security posture within the
// IAM domain. Note: Use permission_analysis_results for identity-centric analysis
// (evaluating what an identity can do) and access_analysis_result for
// resource-centric analysis (evaluating who can access a resource). These
// complement each other for comprehensive IAM security assessment. Note: If the
// Finding is an incident, i.e. requires incident workflow, also apply the incident
// profile or aggregate this finding into an Incident Finding.
type IamAnalysisFinding struct {
	...
	// Details about applications, services, or systems that are accessible based
	// on the IAM analysis. For identity-centric analysis, this represents
	// applications the identity can access. For resource-centric analysis, this
	// represents applications that can access the resource.
	...
	// conjunction with Resource(s). <p> e.g. Specific details about an AWS EC2
	// instance, that is affected by the Finding.</p>
