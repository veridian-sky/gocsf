...
// WinPrefetchQuery Prefetch Query events report information about Windows prefetch files.
type WinPrefetchQuery struct {
	...
	// The event class name, as defined by class_uid value: Prefetch Query.
