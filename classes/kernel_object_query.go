...
// KernelObjectQuery Kernel Object Query events report information about discovered kernel resources.
type KernelObjectQuery struct {
	...
	// The event class name, as defined by class_uid value: Kernel Object Query.
