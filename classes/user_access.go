...
// UserAccess User Access Management events report management updates to a user's privileges.
type UserAccess struct {
	...
	// The event class name, as defined by class_uid value: User Access Management.
