...
// GroupManagement Group Management events report management updates to a group, including updates
...
type GroupManagement struct {
	...
	// The event class name, as defined by class_uid value: Group Management.
