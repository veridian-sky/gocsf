...
// RdpActivity Remote Desktop Protocol (RDP) Activity events report post-authentication remote
...
type RdpActivity struct {
	...
	// The event class name, as defined by class_uid value: RDP Activity.
