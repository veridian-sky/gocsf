...
// ScanActivity Scan events report the start, completion, and results of a scan job. The scan
...
type ScanActivity struct {
	...
	// The policy associated with this Scan event; required if the scan was
