...
type ProcessActivity struct {
	...
	// The actor that performed the activity on the target process. For example,
	// the process that started a new process or injected code into another
	// process.
	Actor *objects.Actor `json:"actor,omitempty"`

	// The permissions that were granted to the process in a platform-native
	// format.
	...
	// The event class name, as defined by class_uid value: Process Activity.
