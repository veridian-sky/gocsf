...
type DroneFlightsActivity struct {
	...
	// The authentication type as defined by the caption of auth_protocol_id. In
	// the case of 'Other', it is defined by the event source.
	AuthProtocol string `json:"auth_protocol,omitempty"`

	// The normalized identifier of the authentication type used to authorize a
	// flight plan or mission.
	...
	// The event category name, as defined by category_uid value: Unmanned Systems.
	CategoryName string `json:"category_name,omitempty"`

	// The category unique identifier of the event.
	CategoryUID int `json:"category_uid,omitempty"`

	// The event class name, as defined by class_uid value: Drone Flights Activity.
	...
	// This optional, free-text field enables the operator to describe the purpose
	...
	// The destination network endpoint of the Unmanned Aerial System (UAS),
	// Counter Unmanned Aerial System (CUAS) platform, or other unmanned systems
	// monitoring and/or sensing infrastructure.
	...
	// normalized to the caption of the status_id value. In the case of 'Other', it
	...
	// Traffic refers to the amount of data transmitted from a Unmanned Aerial
	// System (UAS) or Counter Unmanned Aerial System (UAS) (CUAS) system at a
	// given point of time. Ex: bytes_in and bytes_out.
