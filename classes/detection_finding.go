...
type DetectionFinding struct {
	...
	// Describes baseline information about normal activity patterns, along with
	// any detected deviations or anomalies that triggered this finding.
	...
	// Describes various evidence artifacts associated to the activity/activities
	...
	// Describes details about malware scan job that triggered this Detection
	// Finding.
