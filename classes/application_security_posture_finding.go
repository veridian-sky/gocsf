...
// ApplicationSecurityPostureFinding The Application Security Posture Finding event is a notification about any bug,
...
// control, the security_control profile should be applied and its attacks
// information, if present, should be duplicated into the finding_info object.
// Note: If the Finding is an incident, i.e. requires incident workflow, also apply
// the incident profile or aggregate this finding into an Incident Finding.
type ApplicationSecurityPostureFinding struct {
	...
	// The event class name, as defined by class_uid value: Application Security
	// Posture Finding.
	...
	// reported as part of an Application Security or Vulnerability Management
	// tool's built-in compliance framework mapping.
