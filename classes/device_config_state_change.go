...
// DeviceConfigStateChange Device Config State Change events report state changes that impact the security
// of the device.
type DeviceConfigStateChange struct {
	...
	// The event class name, as defined by class_uid value: Device Config State
	// Change.
	...
	// The Config Change Stat, normalized to the caption of the state_id value. In
