...
// EmailActivity Email Activity events report SMTP protocol and email activities including those
// with embedded URLs and files. See the Email object for details.
type EmailActivity struct {
	...
	// organization.</p>Email scanned at an internet gateway might be characterized
	// as inbound to the organization from the Internet, outbound from the
	// organization to the Internet, or internal within the organization. Email
	// scanned at a workstation might be characterized as inbound to, or outbound
	...
	// The recipient address from the transmission envelope. This may differ from
	// the 'To' header and represents where the message was actually delivered.
