...
// UserInventory User Inventory Info events report user inventory data that is either logged or
...
type UserInventory struct {
	...
	// The actor describes the process that was the source of the inventory
	// activity. In the case of user inventory data, that could be a particular
	// process or script that is run to scrape the user data. For example, it could
	// be a powershell process that runs to pull data from the Azure AD graph API.
