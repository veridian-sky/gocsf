...
// ProcessRemediationActivity Process Remediation Activity events report on attempts at remediating processes.
// It follows the MITRE countermeasures defined by the D3FEND™
// https://d3fend.mitre.org/ Matrix. Sub-techniques will include Process, such as
// Process Termination or Kernel-based Process Isolation.
type ProcessRemediationActivity struct {
	...
	// The event class name, as defined by class_uid value: Process Remediation
	// Activity.
