...
// WinRegistryKeyQuery Registry Key Query events report information about discovered Windows registry
// keys.
type WinRegistryKeyQuery struct {
	...
	// The event class name, as defined by class_uid value: Registry Key Query.
	...
	RegKey *objects.WinRegKey `json:"reg_key,omitempty"`
