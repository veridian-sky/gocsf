...
// WinWindowsResourceActivity Windows Resource Activity events report when a process accesses a Windows
...
type WinWindowsResourceActivity struct {
	...
	// The event class name, as defined by class_uid value: Windows Resource
	// Activity.
	...
	WinResource *objects.WinWinResource `json:"win_resource,omitempty"`
}
