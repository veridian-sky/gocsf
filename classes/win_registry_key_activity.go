...
// WinRegistryKeyActivity Registry Key Activity events report when a process performs an action on a
...
type WinRegistryKeyActivity struct {
	...
	PrevRegKey *objects.WinRegKey `json:"prev_reg_key,omitempty"`
