...
// CloudResourcesInventoryInfo Cloud Resources Inventory Info events report cloud asset inventory data. This
...
// (CAASM), direct public cloud service provider APIs, Software-as-a-Service (SaaS)
// APIs, or otherwise.
type CloudResourcesInventoryInfo struct {
	...
	// The event class name, as defined by class_uid value: Cloud Resources
	// Inventory Info.
	...
	// A cloud-based container image or running container discovered by an
	// inventory process.
	...
	// The Identity Provider that is being discovered by an inventory process, or
	// that is related to the cloud resource(s) being discovered by an inventory
	// process.
	...
	// The cloud region where the resource is located, e.g., us-isof-south-1,
	// eastus2, us-central1, etc.
