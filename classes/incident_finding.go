...
// incidents as a result of detections and/or analytics. Note: Incident Finding
// implicitly includes the incident profile and it should be added to the
// metadata.profiles[] array.
type IncidentFinding struct {
	...
	// tactics, techniques & sub-techniques associated to the Incident.
