...
// FileRemediationActivity File Remediation Activity events report on attempts at remediating files. It
// follows the MITRE countermeasures defined by the D3FEND™
// https://d3fend.mitre.org/ Matrix. Sub-techniques will include File, such as File
// Removal or Restore File.
type FileRemediationActivity struct {
	...
	// The event class name, as defined by class_uid value: File Remediation
	// Activity.
