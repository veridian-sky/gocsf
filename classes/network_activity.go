...
type NetworkActivity struct {
	...
	// The event class name, as defined by class_uid value: Network Activity.
	...
	// The responder of the network connection. In some contexts an event source
	// cannot correctly identify the responder. Refer to
	// is_src_dst_assignment_known for certainty.
	...
	// The initiator of the network connection. In some contexts an event source
	// cannot correctly identify the initiator. Refer to
	// is_src_dst_assignment_known for certainty.
