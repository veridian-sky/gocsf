...
type ApplicationLifecycle struct {
	...
	// The application that was affected by the lifecycle event. This also applies
	// to self-updating application systems.
	...
	// The event class name, as defined by class_uid value: Application Lifecycle.
