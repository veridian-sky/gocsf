...
// NetworkRemediationActivity Network Remediation Activity events report on attempts at remediating computer
// networks. It follows the MITRE countermeasures defined by the D3FEND™
// https://d3fend.mitre.org/ Matrix. Techniques and Sub-techniques will include
// Network, such as Network Isolation or Network Traffic Filtering.
type NetworkRemediationActivity struct {
	...
	// Matches the MITRE D3FEND™ Tactic. Note: the Model and Detect Tactics are
	// not supported as remediations by the OCSF Remediation event class.
	...
	// The event class name, as defined by class_uid value: Network Remediation
	// Activity.
	...
	// The unique identifier of the remediation command that pertains to this
	// event.
