...
// WinWindowsServiceActivity Windows Service Activity events report when a process interacts with the Service
// Control Manager.
type WinWindowsServiceActivity struct {
	...
	// The event class name, as defined by class_uid value: Windows Service
	// Activity.
	...
	// The Windows service.
	WinService *objects.WinWinService `json:"win_service,omitempty"`
}
