...
// Broadcast (ADS-B) receivers. Based on the ADS-B standards described in
// https://www.ecfr.gov/current/title-14/chapter-I/subchapter-F/part-91#91.225 Code
// of Federal Regulations (CFR) Title 14 Chapter I Subchapter F Part 91 and in
...
type AirborneBroadcastActivity struct {
	...
	// The event class name, as defined by class_uid value: Airborne Broadcast
	// Activity.
	...
	// The specific protocol associated with the ADS-B system. E.g. ADS-B UAT or
	// ADS-B ES.
	...
	// Recent average RSSI (signal power) measured in dbFS. This value will always
	// be negative, e.g., -87.13.
	...
	// Traffic refers to the amount of data transmitted from a ADS-B remote
	// monitoring system at a given point of time. Ex: bytes_in and bytes_out.
