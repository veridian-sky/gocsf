...
type DnsActivity struct {
	...
	// The event class name, as defined by class_uid value: DNS Activity.
	...
	// The DNS server response code, normalized to the caption of the rcode_id
	// value. In the case of 'Other', it is defined by the event source.
	Rcode string `json:"rcode,omitempty"`

	// The normalized identifier of the DNS server response code. See
	// https://datatracker.ietf.org/doc/html/rfc6895 RFC-6895.
