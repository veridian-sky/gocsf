...
// PatchState Operating System Patch State reports the installation of an OS patch to a device
...
type PatchState struct {
	...
	// The event class name, as defined by class_uid value: Operating System Patch
	// State.
