...
// InventoryInfo Device Inventory Info events report device inventory data that is either logged
...
type InventoryInfo struct {
	...
	// The event class name, as defined by class_uid value: Device Inventory Info.
