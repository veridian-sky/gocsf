...
type EventLogActvity struct {
	...
	// The event class name, as defined by class_uid value: Event Log Activity.
	...
	// The <p style='display:inline;color:red targeted</p> endpoint for the event
	// log activity.
	...
	// The logging provider or logging service <p style='display:inline;color:red
	// targeted by</p> the activity.<br />Example:
	// Microsoft-Windows-Security-Auditing, Auditd, or Syslog.
	...
	// The event status code, as reported by the event source.<br />Example: 0, 8,
	// or 21 for
	...
	// Windows ClearEventLog.
	StatusCode string `json:"status_code,omitempty"`

	// The status detail contains additional information about the event
	// outcome.<br />Example: Success, Privilege Missing, or Invalid Parameter for
	// https://learn.microsoft.com/en-us/previous-versions/windows/desktop/eventlogprov/cleareventlog-method-in-class-win32-nteventlogfile
	// Windows ClearEventLog.
