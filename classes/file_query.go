...
// FileQuery File Query events report information about files that are present on the system.
type FileQuery struct {
	...
	// The event class name, as defined by class_uid value: File Query.
